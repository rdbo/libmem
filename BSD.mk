...
LIBMEM_CFLAGS=-o $(OUT_DIR)/$(LIBMEM_OUT) -shared -fPIC -DLM_EXPORT -ldl -lkvm -lprocstat -lelf -lutil
TESTS_DIR=./tests
TESTS_SRC=$(TESTS_DIR)/tests.c
TESTS_OUT=tests
TESTS_CFLAGS=-o $(OUT_DIR)/$(TESTS_OUT) -I$(LIBMEM_DIR) -DLM_IMPORT -DTARGET_NAME=\"$(TESTS_OUT)\" -Wl,-R,$(OUT_DIR) -Wl,--enable-new-dtags -L$(OUT_DIR) -l:$(LIBMEM_OUT)
