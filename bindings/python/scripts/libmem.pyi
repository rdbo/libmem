...
def LM_HookCode(_from: lm_address_t, to : lm_address_t) -> lm_address_t: ...
def LM_HookCodeEx(pproc : lm_process_t, _from: lm_address_t, to : lm_address_t) -> lm_address_t: ...
...
def LM_UnhookCode(_from: lm_address_t, trampoline : (lm_address_t, int)) -> bool: ...
def LM_UnhookCodeEx(pproc : lm_process_t, _from: lm_address_t, trampoline : (int, int)) -> bool: ...
