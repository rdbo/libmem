...
class TestLibMem(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_size = 1024
        self.test_module = r"C:\Windows\System32\tapiui.dll"
    ...
    def test_LM_UnloadModule(self):
        ...
        self.assertTrue(LM_UnloadModule(LM_LoadModule(self.test_module)))

    def test_LM_UnloadModuleEx(self):
        # def LM_UnloadModuleEx(pproc: lm_process_t, pmod: lm_module_t) -> Optional[bool]:
        self.assertTrue(LM_UnloadModuleEx(self.ex_program, LM_LoadModuleEx(self.ex_program, self.test_module)))
