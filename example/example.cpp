...
#	endif
	...
	page = mem::in::get_page((mem_voidptr_t)pattern);
	...
	scan = mem::in::scan(pattern, sizeof(pattern), page.base, page.end);
	pattern_scan = mem::in::pattern_scan(pattern, mask, page.base, page.end);
