...
#	elif MEM_OS == MEM_LINUX
	...
	case x86_32:
		...
		break;
	case x86_64:
		snprintf(page_base_str, sizeof(page_base_str), "%lx-", (mem_uint64_t)(mem_uintptr_t)mod.base);
		break;
	default:
		return read_chars;
	}
...
#	elif MEM_OS == MEM_LINUX
	...
	case x86_32:
		...
		break;
	case x86_64:
		snprintf(page_base_str, sizeof(page_base_str), "%lx-", (mem_uint64_t)(mem_uintptr_t)src);
		break;
	default:
		return page;
	}
