...
#	elif MEM_OS == MEM_LINUX
	...
	{
	case x86_32:
		snprintf(page_base_str, sizeof(page_base_str), "%x-", (mem_uint32_t)mod.base);
		break;
	case x86_64:
		snprintf(page_base_str, sizeof(page_base_str), "%lx-", (mem_uint64_t)mod.base);
		break;
	default:
		return read_chars;
	}
...
#	elif MEM_OS == MEM_LINUX
	...
	{
	case x86_32:
		snprintf(page_base_str, sizeof(page_base_str), "%x-", (mem_uint32_t)src);
		break;
	case x86_64:
		snprintf(page_base_str, sizeof(page_base_str), "%lx-", (mem_uint64_t)src);
		break;
	default:
		return page;
	}
