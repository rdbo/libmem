...
main()
{
	...
	*/
	...
	data_scan = LM_DataScanEx(proc, scanme, sizeof(scanme), mod.base, mod.end);
	pattern_scan = LM_PatternScanEx(proc, scanme, mask, mod.base, mod.end);
	sig_scan = LM_SigScanEx(proc, signature, mod.base, mod.end);
